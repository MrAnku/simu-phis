...
Route::middleware(['auth:api', 'timezone', 'throttle:limiter', 'setLocale'])->group(function () {
    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::put('/update-risk-information', [ApiSettingsController::class, 'updateRiskInformation']);
         ...
         // enable overall reporting
          ...
          Route::put('/notification-languages', [ApiSettingsController::class, 'updateNotificationLanguages']);
    ...
    Route::prefix('ai-agents')->group(function () {
        ...
        Route::get('/get-agents', [ApiAiCallController::class, 'getAiAgents']);
        Route::put('/update-agent', [ApiAiCallController::class, 'updateAiAgent']);
        Route::delete('/delete-ai-agent/{agent_id}', [ApiAiCallController::class, 'deleteAiAgentNew']);
    ...
    Route::prefix('custom-training-email')->group(function () {
        ...
        Route::get('/get-template-by-id/{id}', [ApiCustomTrainingEmailController::class, 'getTemplateById']);
