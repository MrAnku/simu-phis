...
<div class="main-content app-content">
    ...
    <div>
        ...
        <button type="button" class="btn btn-success mb-3 me-2" data-bs-toggle="modal" data-bs-target="#newdomainVerificationModal">
            Show/Add Email
        </button>
    </div>
    <div>
        <button type="button" class="btn btn-secondary mb-3" data-bs-toggle="modal" data-bs-target="#domainVerificationModal">
            Domain Verification
        </button>
    </div>
</div>
                                ...
                                <form id="newCampaignForm" action="" method="post">
                                    ...
                                    <fieldset class="included">
                                        <div class="form-card">
                                            ...
                                            <div class="row">
                                            <div class="col-lg-6">
    <input type="hidden" id="campaign_type" name="campaign_type" value="Phishing">
</div>
    ...
    <tr>
        ...
        <td>
            @if ($domain->verified == 1)
                ...
                onclick="openDomainModal('{{ $domain->domain }}')">Show/Add Email</button>
            @endif
...
<!-- Fetch Email Modal -->
<div class="modal fade" id="fetchEmailModal" tabindex="-1" aria-labelledby="fetchEmailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="mt-4">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-primary" id="addEmailButton" onclick="addEmail()">Add Email</button>
                    </div>
...
<style>
    ...
    #emailList li {
        ...
        border-radius: 4px;
        margin-bottom: 1rem; /* Adds space between each email ID */
        color: #007bff;
    }
</style>
...
function addEmail() {
    ...
    li.innerHTML += `<button type="button" class="btn btn-sm btn-danger ms-2" onclick="removeEmail('${email}')">Remove</button>`;
    emailList.appendChild(li);
  ...
  if (domains.length > 0) {
    ...
    fetch("/submit-domains", {
      ...
      headers: {
        ...
        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'), // Ensure this meta tag exists
      },
...
<div class="modal" id="newDomainVerificationModal" tabindex="-1" aria-labelledby="exampleModalLgLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-muted">
          Domain verification is performed through challenge-response authentication of the provided email addresses. 
        ...
        <form id="domainForm" method="post" onsubmit="return false;">
          <div class="mb-3">
            <label for="domainEmailInput" class="form-label">Domain<sup class="text-danger">*</sup></label>
            <input type="text" class="form-control" id="domainEmailInput" placeholder="Enter email address" />
          </div>
        ...
        <button type="button" id="sendOtpBtn" class="btn btn-primary my-3" onclick="submitDomains()">Submit Domains for Verification</button>
