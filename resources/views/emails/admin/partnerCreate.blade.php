<!DOCTYPE html>
        ...
        <body>
            <div class="container">
                <h1>Welcome to simUphish Partnership</h1>
                <p>Congratulations! You\'re now the partner of simUphish.</p>
                <p>You can now access your partner dashboard and resources by logging in with the following credentials:</p>
                <div class="credentials">
                    <p>Portal: <a href="https://partner.simuphish.com" target="_blank">partner.simuphish.com<a></p>
