...
<body>
    <div class="email-container" style="padding: 20px">
        <div class="content">
            ...
            <p>A data breach has been detected that may have affected one of your employee associated with the account {{ $employee->user_email }}. This breach may have compromised sensitive data. Below are the details of the breach:</p>
            ...
            <ol>
                ...
                <li>Contact the affected service provider (if applicable) to determine if further action is required.</li>
            </ol>
    
            <p>Please act quickly to minimize the impact of this breach and ensure that the employee's account is secured.</p>
