                                ...
                                "
                                  ...
                                  "
                                          ...
                                          font-family: Arial, "Helvetica
                                                                    Neue", Helvetica, sans-serif; font-size: 27px;
                                                                    font-weight: 700; letter-spacing: normal;
                                                                    line-height: 120%; text-align: center; margin-top:
                                                                    0; margin-bottom: 0; mso-line-height-alt:
                                                                    32.4px; "
                                      >
                                      ...
                                      <div
                                        style="
                                          ...
                                          font-family: Arial, "Helvetica Neue"
                                                                    ...
                                                                    120%; text-align: left; mso-line-height-alt:
                                                                    18px; "
                                      >
                                        <p style="margin: 0">
                                          Training
                                          <em><strong>{{ $mailData['training_name'] }} </strong></em>is
                                  ...
                                  <tr>
                                    <td class="pad">
                                      ...
                                      >
                                        <p style="margin: 0">
                                          Username:
                                          <strong>{{ $mailData['login_email'] }}</strong>
                                        </p>
                                      </div>
                                    </td>
                                  </tr>
                                ...
                                >
                                  <tr>
                                    <td class="pad">
                                      ...
                                      >
                                        <p style="margin: 0">
                                          Password: <strong>{{ $mailData['login_pass'] }}</strong>
                                        </p>
                                      </div>
                                    </td>
                                  </tr>
                                        ...
                                        [endif]--><a
                                          ...
                                          style="
                                            ...
                                            font-family: Arial, "Helvetica Neue"
                                                                    ...
                                                                    text-align: center; mso-border-alt: none;
                                                                    word-break:
                                                                    keep-all; "
                                          target="_blank"
                                          ><span
                                  ...
                                  <tr>
                                    <td
                                      ...
                                      style="
                                        ...
                                        color: #1e0e4b;
                                        font-family: "Inter"
                                                                    , sans-serif; font-size: 15px; padding-bottom: 5px;
