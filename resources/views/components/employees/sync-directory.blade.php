<div class="card-body">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="order-tab" data-bs-toggle="tab" data-bs-target="#order-tab-pane"
                type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true"><i
                    class="ri-copyleft-line me-1 align-middle"></i>{{ __('LDAP AD') }}</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="confirmed-tab" data-bs-toggle="tab" data-bs-target="#confirm-tab-pane"
                type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false"><i
                    class="ri-windows-line me-1 align-middle"></i>{{ __('Outlook/Azure') }}</button>
        </li>
        {{-- <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
            ...
            <div id="ldapConfig">
                <form class="text-center" id="ldapConfigForm" method="post"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                <label for="ldap_host" class="col-sm-2 col-form-label">{{ __('LDAP Host') }}</label>
                                <div class="col-sm-10">
                        ...
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                <label for="ldap_dn" class="col-sm-2 col-form-label">{{ __('LDAP DN') }}</label>
                                <div class="col-sm-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                <label for="ldap_admin" class="col-sm-2 col-form-label">{{ __('Admin Username') }}</label>
                                <div class="col-sm-10">
                        ...
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                <label for="ldap_pass" class="col-sm-2 col-form-label">{{ __('Admin Password') }}</label>
                                <div class="col-sm-10">
        ...
        <div class="tab-pane fade text-muted" id="confirm-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
            ...
            <div>
                <p class="text-muted">
                    {{ __('Refer to our knowledge base article for setup instructions. simUphish will request permission to access directory data, including users and groups. We will also retrieve the profile information of the authorizing user.') }}
                </p>
            </div>
            <div class="text-center">
                ...
                @else
                <p class="h5 mb-3 text-success">{{ __('You can now import employees from your Outlook AD') }}</p>
