                            ...
                            <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                    ...
                                    <div class="simplebar-content" style="padding: 16px;">
                                        ...
                                        <li class="px-0">
                                            <span class="fs-11 text-muted op-7 fw-semibold">{{ __('ONLINE
                                                USERS') }}</span>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                <div class="d-flex align-items-top lh-1">
                                                    ...
                                                    <div>
                                                        <p class="text-default fw-semibold mb-1">
                                                            {{ __('Angelica') }}</p>
                                                        <p class="fs-12 text-muted mb-0">{{ __('Hello this is
                                                            angelica.') }}</p>
                                                    </div>
                                                </div>
                                            </a>
                ...
                <div class="responsive-mail-action-icons">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="javascript:void(0);"><i
                                        class="ri-spam-2-line me-1 align-middle d-inline-block"></i>{{ __('Report') }}
                                    Spam</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);"><i
