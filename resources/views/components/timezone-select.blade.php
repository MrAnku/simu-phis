<select class="select2 form-control custom-select select2-hidden-accessible" style="width: 100%" name="{{$name}}" id="{{$id}}"
    aria-invalid="false" data-select2-id="{{$id}}" tabindex="-1" aria-hidden="true">
