<div class="card-body">
    <ul class="nav nav-pills justify-content-start nav-style-3 mb-3" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="smishing-detail" data-bs-toggle="tab" role="tab" aria-current="page" href="#home-right"
                aria-selected="true">{{ __('Smishing') }}</a>
        </li>
        <li class="nav-item smishing-training-detail" role="presentation" style="display: none;">
                        ...
                        <table class="table text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">{{ __('SMS Delivered') }}</th>
                                    <th scope="col">{{ __('Payload Clicked') }}</th>
                                    <th scope="col">{{ __('Compromised') }}</th>
                                </tr>
                            </thead>
