<div class="card custom-card">
    <div class="card-header">
        <div class="card-title">{{ __('Active Attack Vector') }}</div>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-3">
                ...
                <p class="mb-0 fs-12 text-muted text-truncate text-center">{{ __('Phishing') }}</p>
            </div>
            <div class="col-lg-3">
                ...
                <p class="mb-0 fs-12 text-muted text-truncate text-center">{{ __('WhatsApp') }}</p>
            </div>
            <div class="col-lg-3 mb-2">
                ...
                <p class="mb-0 fs-12 text-muted text-truncate text-center">{{ __('Quishing') }}</p>
            </div>
            @if($activeTprm)
            <div class="col-lg-3 mb-2">
                ...
                <p class="mb-0 fs-12 text-muted text-truncate text-center">{{ __('TPRM') }}</p>
            </div>
            @endif
            @if($activeAIVishing)
            <div class="col-lg-3 mb-2">
                ...
                <p class="mb-0 fs-12 text-muted text-truncate text-center">{{ __('AI Vishing') }}</p>
            </div>
            @endif
        </div>
    </div>
