        ...
        <div class="col-md-12 mx-0">
            <form id="newCampaignForm" action="" method="post">
                ...
                <fieldset class="included">
                    ...
                    <x-campaign.next-button label="Next" class="next" />
                </fieldset>

                <fieldset class="included" id="pm_step_form">
                    <x-campaign.previous-button label="Previous" class="previous" />
                    <x-campaign.next-button label="Next" class="next" />
                ...
                <fieldset class="included">
                    ...
                    <x-campaign.previous-button label="Previous" class="previous" />
                    <x-campaign.next-button label="Next" class="next last-step" />
                </fieldset>

                <fieldset class="included">
                    <x-campaign.review-campaign />
                    <x-campaign.previous-button label="Previous" class="previous" />
                    <x-campaign.next-button label="Submit" id="createCampaign" />
                </fieldset>
            </form>
        </div>
    </div>
