<ul class="nav nav-tabs tab-style-2 nav-justified mb-3 d-sm-flex d-block" id="myTab1" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="quish-mat" data-bs-toggle="tab" data-bs-target="#quish-mat-pane" type="button" role="tab" aria-controls="quish-mat-pane" aria-selected="false" tabindex="-1" disabled="true"><i class="ri-file-list-line me-1 align-middle"></i>{{ __('Quishing Material') }}</button>
    </li>
    <li class="nav-item" role="presentation">
