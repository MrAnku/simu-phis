<div id="gamified_training_form">
    <form action="{{auth('company')->check() ? route('add.gamified_training') : route('admin.add.gamified_training') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-4">
                <div class="input-group mb-3">
                    <span class="input-group-text">{{ __('Module name') }}</span>
                    <input type="text" class="form-control required" name="module_name" placeholder="{{ __('Enter a unique module name') }}"
            ...
            <div class="col-lg-4">
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" name="category" id="g_category">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="input-group">
                    <label class="input-group-text" for="g_coverImageFile">{{ __('Cover Image') }}</label>
                    <input type="file" class="form-control" name="cover_file" id="g_coverImageFile">
            ...
            <input type="hidden" id="gamifiedJsonData" name="gamifiedJsonData" value="">
            <input type="submit" id="addGamifiedTrainingSubmitBtn" value="Submit" class="d-none">
...
<div>
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" id="gamified_training_video_url" name="gamified_training_video_url"
            data-name="Gamified Training Video" required>
        <button class="btn btn-primary" type="button" id="fetchVideoUrl" onclick="fetchVideoUrl()">{{ __('Fetch Video') }}</button>
    </div>
</div>

<div id="game_training_video_preview" style="display: none;">
    <video id="gameTrainingVideoPlayer" controls style="width: 100%;">
        <source src="https://sparrow.host/videos/financial-AR.mp4" type="video/mp4">
        {{ __('Your browser does not support the video tag.') }}
    </video>
</div>

<div id="gamified_questions_container" style="display: none;">
...
<div class="d-flex justify-content-end mt-3">
    <button type="button" class="btn btn-primary" onclick="saveGamifiedQues()">
        {{ __('Submit') }}
    </button>
</div>
