...
@section('title', 'Phishing Emails | simUphish')
                                        ...
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-footer">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <button type="button" onclick="editETemplate(`{{ $pemail->id }}`)"
    ...
    <div class="modal fade" id="newPhishingmailModal" tabindex="-1" aria-labelledby="exampleModalLgLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.addEmailTemplate') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editEtemplateModal" tabindex="-1" aria-labelledby="exampleModalLgLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.phishing.update') }}" method="post">
                        @csrf
                        <div class="mb-3">
